...
if (CPPMODULE_CPPPINYIN)
  ...
  set(CPP_PINYIN_BUILD_STATIC ON)
  add_subdirectory(${CPPMODULE_ROOTPATH}/cpp-pinyin ${CPPMODULE_BINARY_SUBDIR}/cpp-pinyin)
  link_directories(${CPPMODULE_BINARY_SUBDIR}/cpp-pinyin)
  set(CPPMODULE_LINK_LIBRARIES_ALL cpp-pinyin::cpp-pinyin ${CPPMODULE_LINK_LIBRARIES_ALL} )
